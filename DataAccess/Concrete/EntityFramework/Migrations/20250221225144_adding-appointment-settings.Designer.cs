...
namespace DataAccess.Concrete.EntityFramework.Migrations
{
    ...
    [Migration("20250221225144_adding-appointment-settings")]
    partial class addingappointmentsettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entity.Concrete.AppointmentSetting", b =>
                {
                    ...
                    b.Property<int>("EndTimeInHoursForAppointments")
                        .HasColumnType("int");

                    b.Property<int>("StartTimeInHoursForAppointments")
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTimeInHoursForAppointments = 16,
                            StartTimeInHoursForAppointments = 8
                        });
                });
